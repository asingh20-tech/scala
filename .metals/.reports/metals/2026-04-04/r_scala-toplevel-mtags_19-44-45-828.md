error id: file://<WORKSPACE>/src/main/scala/example/MainProject.scala:[842,843) in virtfile:file://<WORKSPACE>/src/main/scala/example/MainProject.scala(... e{
  def 
}
case clas ...)
file://<WORKSPACE>/file:<WORKSPACE>/src/main/scala/example/MainProject.scala
file://<WORKSPACE>/src/main/scala/example/MainProject.scala:39: error: expected identifier; obtained rbrace
