error id: file://<WORKSPACE>/src/main/scala/example/MainProject.scala:example/E#eval().(env)
file://<WORKSPACE>/src/main/scala/example/MainProject.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol example/E#eval().(env)
