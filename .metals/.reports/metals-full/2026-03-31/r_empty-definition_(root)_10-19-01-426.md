error id: file://<WORKSPACE>/src/main/scala/example/MainProject.scala:prettyPrint.
file://<WORKSPACE>/src/main/scala/example/MainProject.scala
empty definition using pc, found symbol in pc: prettyPrint.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/io/StdIn.utils.prettyPrint.
	 -scala/io/StdIn.utils.prettyPrint#
	 -scala/io/StdIn.utils.prettyPrint().
	 -scala/util/control/Breaks.utils.prettyPrint.
	 -scala/util/control/Breaks.utils.prettyPrint#
	 -scala/util/control/Breaks.utils.prettyPrint().
	 -utils/prettyPrint.
	 -utils/prettyPrint#
	 -utils/prettyPrint().
	 -scala/Predef.utils.prettyPrint.
	 -scala/Predef.utils.prettyPrint#
	 -scala/Predef.utils.prettyPrint().
offset: 9467
